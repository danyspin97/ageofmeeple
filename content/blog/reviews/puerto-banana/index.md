+++
title = "Puerto Banana - Review"
description = "All my friends went bananas. A review of the game Puerto Banana"
template = "article.html"
date = 2026-05-03
authors = [ "Danilo Spinella" ]
[taxonomies]
tags = [ "bidding", "party", "filler" ]
[extra]
toc = true
toc_sidebar = true
reading_time = 4
...
| **Players:** 2–6 | **Play time:** ~10 min | **Category:** Bidding / Filler |
|------------------|------------------------|--------------------------------|
...
![Puerto Banana round example](rules.webp#no-hover#start "First round played")
...
{{ verdict (vote="8.5", text="Puerto Banana is a highly interactive filler
that earns its place at the end of any game night. Games last no more than 10
minutes, it scales up to 6 players, and everyone can jump in after a single
example round. Yes, some players will write random numbers all night and never
